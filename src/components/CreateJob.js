...
class CreateJob extends Component {
    ...
    render() {
        const { name, company_name, job_category, experience, job_description, gender, email, pincode } = this.state;
        return (
            <div>
                <br /><br />
                <h1>Post your Job!</h1>
                ...
                <form onSubmit={this.onSubmit}>
                    <div className='form-group'>
                        ...
                        <input type='text' value={name} name='job_title' onChange={this.onChangehander} />
                    </div>
                    <div className='form-group'>
